    ...
    public static function register()
    {
        ...
        foreach (Language::getLanguages() as $language) {
            if (Tools::strtolower($language['iso_code']) == 'pt') {
                $order_state->name[$language['id_lang']] = 'Reembolsado';
            } else {
                $order_state->name[$language['id_lang']] = 'refunded';
            }
        }
        ...
        if ($order_state->add()) {
            ...
            Configuration::updateValue('PAYSHOP_ORDER_STATUS_REFUNDED', (int) $order_state->id);
        }
    }
}